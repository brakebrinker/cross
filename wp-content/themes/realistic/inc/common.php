...
// Display Thumbnail/Featured image video
if ( !function_exists( 'realistic_get_thumbnail_video' ) ) {
    function realistic_get_thumbnail_video( $post_id, $size = 'featured' ) {
        ...
        if ( has_post_thumbnail( $post_id ) ) {
            ...
            $image = get_template_directory_uri() . '/images/nothumbvideo-'. $size .'.jpg';
        }
...
function register_stream_post_type(){
    register_post_type('stream', array(
        'labels'             => array(
            'name'               => 'Трансляции', // Основное название типа записи
            'singular_name'      => 'Трансляция', // отдельное название записи типа Book
            'add_new'            => 'Добавить новую',
            'add_new_item'       => 'Добавить новую Трансляцию',
            'edit_item'          => 'Редактировать Трансляцию',
            'new_item'           => 'Новая Трансляция',
            'view_item'          => 'Посмотреть Трансляцию',
            'search_items'       => 'Найти Трансляцию',
            'not_found'          =>  'Трансляций не найдено',
            'not_found_in_trash' => 'В корзине Трансляций не найдено',
            'parent_item_colon'  => '',
            'menu_name'          => 'Трансляции'
