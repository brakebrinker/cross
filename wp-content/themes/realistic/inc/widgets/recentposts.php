				...
				<div class="widget-post-img">
					<a rel="nofollow" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                        <?php if ( $post_format === 'video' ): ?>
                            <img src="<?php echo realistic_get_thumbnail_video( $posts->ID, 'thumbnail' ); ?>" class="attachment-featured wp-post-image" alt="<?php the_title_attribute(); ?>">
                        <?php else: ?>
						    <img src="<?php echo realistic_get_thumbnail( $posts->ID, 'thumbnail' ); ?>" class="attachment-featured wp-post-image" alt="<?php the_title_attribute(); ?>">
                        <?php endif; ?>
                        <?php realistic_post_format_icon( $post_format ); ?>
					</a>
				</div>
				<?php } ?>
